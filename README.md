...
- Proposed formal GPU slots remain DDIS Poisson/Helmholtz 0/2, surrogate 3/1, shared flow prior 5/7, and FunDPS candidate pool 4/6. GPU4 is occupied by unrelated jobs; memory gates and experiment locks prevent unsafe starts. All eight supervised training queues were restored at server time 01:09 on 2026-09-20 after checks passed; they currently wait for verified train and validation datasets. Formal training has not started yet.
